  ...
  return (
    <Container>
      ...
      <Right>
        <Title>Contact</Title>
        <ContactItem>
          <Room style={{marginRight:"10px"}}/> Jl. Raya Bandung Sumedang KM.21, Hegarmanah, Kec. Jatinangor, Kabupaten Sumedang, Jawa Barat 45363
        </ContactItem>
        <ContactItem>
          <Phone style={{marginRight:"10px"}}/> +6285112345678
        </ContactItem>
        <ContactItem>
          <MailOutline style={{marginRight:"10px"}} /> padjadjaranmart@gmail.com
        </ContactItem>
